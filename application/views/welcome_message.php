...
<!--<div  style="float: right">
  ...
  <h2 class="display-3"> Demo - Build, deploy and scale applications faster</h2> 
     <br/>  
  <p class="lead">
...
<div class="container">
    <h1 class="text-center v-center" style="padding-bottom:20px">Workshop Azure App Consult - PaaS Container on Azure - Get started with App Service on Linux</h1>
</div>
<div class="container">
